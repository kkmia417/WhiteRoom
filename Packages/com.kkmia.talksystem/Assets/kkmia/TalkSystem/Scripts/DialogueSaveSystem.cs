...
namespace kkmia.TalkSystem
{
    ...
    public class DialogueSaveSystem : MonoBehaviour
    {
        ...
        private void ReportLocal(DialogueSaveOperationResult result)
        {
            ...
            // Save data is external and may legitimately be stale or corrupt. Surface
            // failures through the result/events so consumers can show slot feedback;
            // expected recoverable data problems must not pollute the Unity Console.
